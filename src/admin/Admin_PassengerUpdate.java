 ...
 * @author HP
 */
public class Admin_PassengerUpdate extends javax.swing.JFrame {

    public Admin_PassengerUpdate() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        SideBarPanel2.add(LogoutPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 380, 80));
        ...
        updatePassengerInformationLabel.setText("UPDATE PASSENGER INFORMATION");
        ...
        passengerID.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 24)); // NOI18N
        passengerID.setText("PSG-");

        pidlabel.setFont(new java.awt.Font("Verdana", 1, 28)); // NOI18N
                            ...
                            .addGroup(dashboardPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(dashboardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, dashboardPanelLayout.createSequentialGroup()
                                        .addGap(26, 26, 26)
                                        .addComponent(passengerID, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(18, 18, 18)
            ...
            .addGroup(dashboardPanelLayout.createSequentialGroup()
                ...
                .addGroup(dashboardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(dashboardPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(dashboardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(passengerID, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(dashboardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(dashboardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(cnicLabel)
                        .addComponent(nameLabel))
                    .addComponent(nameTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(0, 0, 0)
                .addComponent(passportValidation)
                .addGap(85, 85, 85)
                .addGroup(dashboardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
       ...
       JOptionPane.showMessageDialog(this, "Use this format: 03XXXXXXXXX", "Invalid Phone Number", 2);
        ...
        JOptionPane.showMessageDialog(this, "Invalid address");
            ...
            if(db.updatePassengerDetails(passengerID.getText(), nameTextField.getText(), cnicTextField.getText(), passportTextField.getText(), genderComboBox.getSelectedItem().toString(), contactTextField.getText(), addressTextField.getText())==1){
                JOptionPane.showMessageDialog(this, "Successfully Passenger Details has been Updated", "Passenger Details", 1);
            }else{
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try {
            DB_Connectivity db = new DB_Connectivity();
            rs = db.PassengerSearchByID(passengerID.getText());
            if (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_PassengerUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_PassengerUpdate().setVisible(true);
            }
        });
    }
