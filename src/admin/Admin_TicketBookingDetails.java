 ...
 * @author HP
 */
public class Admin_TicketBookingDetails extends javax.swing.JFrame {
 ResultSet rs;
    public Admin_TicketBookingDetails() {
        try {
            initComponents();
            DB_Connectivity db = new DB_Connectivity();
            rs = db.getTicketDetails();
            DefaultTableModel tb =(DefaultTableModel)ticketDetailsTable.getModel();
            
            while(rs.next()){
            String row[]={rs.getString("ticket_no"),rs.getString("passenger_ID"),rs.getString("flight_no"),rs.getString("name"),rs.getString("source"),rs.getString("destination"),rs.getString("departure"),rs.getString("arrival"),rs.getString("flight_date")};
            tb.addRow(row); 
            }
    ...
    private void initComponents() {
        ...
        ticketDetailsTable = new rojeru_san.complementos.RSTableMetro();
        ...
        passengerDetailsLabel1.setText("TICKET BOOKING");
        ...
        ticketDetailsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ticket No", "Passenger ID", "Flight No", "P_Name", "Source", "Destination", "Departure", "Arrival", "Date"
            }
        ));
        ticketDetailsTable.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        ticketDetailsTable.setColorFilasForeground1(new java.awt.Color(0, 0, 0));
        ticketDetailsTable.setColorFilasForeground2(new java.awt.Color(0, 0, 0));
        ticketDetailsTable.setColorSelBackgound(new java.awt.Color(204, 204, 204));
        ticketDetailsTable.setColorSelForeground(new java.awt.Color(0, 0, 0));
        ticketDetailsTable.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 24)); // NOI18N
        ticketDetailsTable.setFuenteFilas(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ticketDetailsTable.setFuenteHead(new java.awt.Font("Yu Gothic UI Semibold", 1, 24)); // NOI18N
        ticketDetailsTable.setRowHeight(36);
        ...
        SideBarPanel2.add(LogoutPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 500, 380, 80));
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        ResultSet rs;
            rs=db.findTicket(searchField.getText());
        DefaultTableModel tb=(DefaultTableModel)ticketDetailsTable.getModel();
        tb.setRowCount(0);
        try {
            while(rs.next()){
                String vector[]={rs.getString("ticket_no"),rs.getString("passenger_ID"),rs.getString("flight_no"),rs.getString("name"),rs.getString("source"),rs.getString("destination"),rs.getString("departure"),rs.getString("arrival"),rs.getString("flight_date")};
                tb.addRow(vector);
            }
        } catch (SQLException ex) {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        // TODO add your handling code here:
        Admin_TicketBooking pa = new Admin_TicketBooking();
        pa.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_TicketBookingDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_TicketBookingDetails().setVisible(true);
            }
        });
    }
    ...
    private rojeru_san.complementos.RSTableMetro ticketDetailsTable;
