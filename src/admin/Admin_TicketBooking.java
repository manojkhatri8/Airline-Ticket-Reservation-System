 ...
 * @author HP
 */
public class Admin_TicketBooking extends javax.swing.JFrame {
ResultSet rs;
    public Admin_TicketBooking() {
        initComponents();
        ...
        Logger.getLogger(Admin_TicketBooking.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private String getNextTicketNumber(String lastTicketNumber) {
        String numericPart = lastTicketNumber.substring(4);
        int ticketNumber = Integer.parseInt(numericPart);
        ticketNumber++;
        return String.format("TKT-%03d", ticketNumber);
    }
    ...
    private void ticketBookButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ticketBookButtonActionPerformed
        ...
        DB_Connectivity db = new DB_Connectivity();//object
            ...
            if (db.TicketDetails(tktno.getText(),passengerIDComboBox.getSelectedItem().toString(), flightNoComboBox.getSelectedItem().toString(), nameTextField.getText(), cnicTextField.getText(), sourceField.getText(), destinationField.getText(), departureField.getText(), arrivalField.getText(), flightDayField.getText(), dateChooser.getDate().toLocaleString(), flightClassComboBox.getSelectedItem().toString(), Integer.parseInt(ticketPriceField.getText()) )== 1) {
                ...
                Admin_TicketBooking tb = new Admin_TicketBooking();
                tb.setVisible(true);
                dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_TicketBooking.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_TicketBooking().setVisible(true);
            }
        });
    }
