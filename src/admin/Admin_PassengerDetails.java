 ...
 * @author HP
 */
public class Admin_PassengerDetails extends javax.swing.JFrame {
 ResultSet rs;
    public Admin_PassengerDetails() {
        try {
            initComponents();
            DB_Connectivity db = new DB_Connectivity();
            rs = db.getPassengerDetails();
            DefaultTableModel tb =(DefaultTableModel)passengerDetailsTable.getModel();
    ...
    private void initComponents() {
        ...
        passengerDetailsTable = new rojeru_san.complementos.RSTableMetro();
        ...
        passengerDetailsLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project_Images/Passenger_Img.png"))); // NOI18N
        ...
        passengerDetailsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Passenger ID", "Name", "CNIC", "Passport", "Gender", "Contact", "Address"
            }
        ));
        passengerDetailsTable.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        passengerDetailsTable.setColorFilasForeground1(new java.awt.Color(0, 0, 0));
        passengerDetailsTable.setColorFilasForeground2(new java.awt.Color(0, 0, 0));
        passengerDetailsTable.setColorSelBackgound(new java.awt.Color(204, 204, 204));
        passengerDetailsTable.setColorSelForeground(new java.awt.Color(0, 0, 0));
        passengerDetailsTable.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 24)); // NOI18N
        passengerDetailsTable.setFuenteFilas(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        passengerDetailsTable.setFuenteFilasSelect(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        passengerDetailsTable.setFuenteHead(new java.awt.Font("Yu Gothic UI Semibold", 1, 24)); // NOI18N
        passengerDetailsTable.setRowHeight(36);
        jScrollPane1.setViewportView(passengerDetailsTable);
        ...
        passengerDetailsLabel1.setText("PASSENGER DETAILS");
        ...
        dashboardPanelLayout.setVerticalGroup(
            ...
            .addGroup(dashboardPanelLayout.createSequentialGroup()
                .addGroup(dashboardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(dashboardPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(passengerDetailsLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(dashboardPanelLayout.createSequentialGroup()
                        .addGap(25, 25, 25)
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        ResultSet rs;
        rs=db.findPassenger(searchField.getText());
        DefaultTableModel tb=(DefaultTableModel)passengerDetailsTable.getModel();
        tb.setRowCount(0);
        try {
            while(rs.next()){
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        // TODO add your handling code here:
        Admin_PassengerAdd pa = new Admin_PassengerAdd();
        pa.setVisible(true);
        dispose();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        // TODO add your handling code here:
         DB_Connectivity db=new DB_Connectivity();
         DefaultTableModel tb=(DefaultTableModel)passengerDetailsTable.getModel();
         String rowid=(String) tb.getValueAt(passengerDetailsTable.getSelectedRow(),0);
        if(db.RemovePassengerBYID(rowid)==1){
          ...
          tb.setRowCount(0);
            while(rs.next()){
            String row[]={rs.getString("pid"),rs.getString("name"),rs.getString("cnic"),rs.getString("passport"),rs.getString("gender"),rs.getString("contact"),rs.getString("address")};
            tb.addRow(row);    
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        // TODO add your handling code here:
        Admin_PassengerUpdate pu = new Admin_PassengerUpdate();
        pu.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_PassengerDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_PassengerDetails().setVisible(true);
            }
        });
    }
    ...
    private rojeru_san.complementos.RSTableMetro passengerDetailsTable;
