 ...
 * @author HP
 */
public class TicketPrices extends javax.swing.JFrame {
    ResultSet rs;
    public TicketPrices() {
           try {
            initComponents();
            DB_Connectivity db = new DB_Connectivity();
            rs = db.getTicketPrices();
            DefaultTableModel tb =(DefaultTableModel)TableofTicketPrices.getModel();
    ...
    private void initComponents() {
        ...
        TableofTicketPrices = new rojeru_san.complementos.RSTableMetro();
        ...
        TableofTicketPrices.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Flight No", "Economy Price", "Business Class Price"
            }
        ));
        TableofTicketPrices.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        TableofTicketPrices.setColorFilasForeground1(new java.awt.Color(0, 0, 0));
        TableofTicketPrices.setColorFilasForeground2(new java.awt.Color(0, 0, 0));
        TableofTicketPrices.setColorSelBackgound(new java.awt.Color(204, 204, 204));
        TableofTicketPrices.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 24)); // NOI18N
        TableofTicketPrices.setFuenteFilas(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        TableofTicketPrices.setFuenteHead(new java.awt.Font("Yu Gothic UI Semibold", 1, 24)); // NOI18N
        TableofTicketPrices.setRowHeight(36);
        jScrollPane1.setViewportView(TableofTicketPrices);
        ...
        ticketPricesPanel.setBackground(new java.awt.Color(255, 51, 51));
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        // TODO add your handling code here:
         ...
         ResultSet rs;
         rs=db.findPriceByFlightNo(searchField.getText());
         DefaultTableModel tb=(DefaultTableModel)TableofTicketPrices.getModel();
         tb.setRowCount(0);
        try {
            while(rs.next()){
                String vector[]={rs.getString(1),rs.getString(7),rs.getString(8)};
                        tb.addRow(vector);
            }
        } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicketPrices.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicketPrices().setVisible(true);
            }
        });
    }
    ...
    private rojeru_san.complementos.RSTableMetro TableofTicketPrices;
